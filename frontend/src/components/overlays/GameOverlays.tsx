...
const ScoreTable: React.FC<{ entries: HighScoreEntry[]; theme: OverlayTheme }> = ({ entries, theme }) => (
    ...
    >
        <p
            className="mb-2 text-center font-[family-name:var(--font-orbitron)] text-[0.62rem] uppercase tracking-[0.22em]"
        ...
        {entries.map((entry, i) => (
            <div
                ...
                style={{
                    background: i % 2 === 0 ? theme.scoreChipBg : 'rgba(255,255,255,0.04)',
        ...
        {isVisible && (
            ...
            >
                ...
                >
                    ...
                    <div className="mb-5 rounded-xl border px-3 py-2" style={{ borderColor: theme.borderColor, background: 'rgba(9,24,14,0.55)' }}>
...
const loseTheme: OverlayTheme = {
    ...
    title: 'Game Over',
    subtitle: 'La grenouille a coule. Respire et repars pour un nouveau run.',
    icon: '💀',
...
const winTheme: OverlayTheme = {
    ...
    title: 'Victory',
    subtitle: 'Bravo. Tu as securise la traversee, continue sur cette lancee.',
    icon: '🏆',
...
export const VictoryOverlay: React.FC<OverlayProps> = (props) => (
    <OverlayCard {...props} theme={winTheme} />
);
